                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#addBlog">
                            <i class="bi bi-plus-square"></i> Tambah Blog
                        </button>
                            ...
                            <tbody class="text-center">
                                @forelse ($blogs as $i => $blog)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editBlog{{ $blog->id }}">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                            <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#showBlog{{ $blog->id }}">
                                                <i class="bi bi-eye-fill"></i>
                                            </button>
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('blog.destroy', $blog->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center">Data Blog belum tersedia.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
